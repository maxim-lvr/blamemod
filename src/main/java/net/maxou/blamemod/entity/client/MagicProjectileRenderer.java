...
import net.maxou.blamemod.entity.custom.MagicProjectileEntity;
...
public class MagicProjectileRenderer extends EntityRenderer<MagicProjectileEntity> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(BlameMod.MOD_ID, "textures/entity/magic_projectile.png");
